...
| `sgmii_differential_pairs` | 0 | 2 | 0 |
| `sgmii_termination` | 0 | 1 | 0 |
| `spi_signals` | 0 | 1 | 0 |
| `uart_signals` | 0 | 1 | 0 |
...
### `sgmii_differential_pairs` — 2 finding(s)

- **SerDes/SGMII net 'ETH_TXP' has no series AC-coupling capacitor — required for DC isolation**
  - Affected: `ETH_TXP`
- **SerDes/SGMII net 'ETH_TXN' has no series AC-coupling capacitor — required for DC isolation**
  - Affected: `ETH_TXN`

### `sgmii_termination` — 1 finding(s)

- **SerDes pair 'ETH_TX' has no termination resistor — missing on: ETH_TXP, ETH_TXN**
  - Affected: `ETH_TXP, ETH_TXN`
